<div class="row">
	...
	<div class="sidebar">
		...
		<a href="/index.php/women">
			<h1 style="color: #5E9DC8">Women</h1>
		</a>
		...
		foreach($dresses as $a_dress) { ?>
			...
			<div class="main-page">
				<a href="/index.php/<?php echo $a_dress->gender; ?>/<?php echo $a_dress->category; ?>/<?php echo $a_dress->slug; ?>" >
					<img class="product-image" src="/assets/images/products<?php echo $a_dress->default_image; ?>" alt="productImage" width="150" height="auto"/>
				</a>
